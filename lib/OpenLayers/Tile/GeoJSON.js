 ...
 * 
 */
OpenLayers.Tile.GeoJSON = OpenLayers.Class(OpenLayers.Tile, {
    ...
    draw: function(force) {
        ...
        this.dummyLayer = new OpenLayers.Layer.Vector("GeoJSON"+Math.random(), {
        	...
        	eventListeners: { "featuresadded": function(evt) {
        	   	// console.log("GeoJson.js: featuresadded callback");
            	// console.log("GeoJson.js: " + evt.features.length + " features");
            	// Find the layer to add our features too
            	featureLayer = tile.layer.featureLayer;
            	// Add our features
            	featureLayer.addFeatures(evt.features);
        	}}
        });
        // dummy things up ...
    ...
    CLASS_NAME: "OpenLayers.Tile.GeoJSON"
});
