    ...
    .Class(
        OpenLayers.Layer.OSM,
        {
          ...
          initialize : function(name, url, options) {
            ...
            this.events.register("loadend", this, function(evt) {
              console.log("loadend");
            });
            this.events.register("moveend", this, function(evt) {
              console.log("moveend");
              this.scheduleMergeFeatures(this.initialDelay);
            });
            this.events.register("tileloadstart", this, function(evt) {
              // console.log("tileloadstart " + this.name);
            });
            this.events.register("tileloaderror", this, function(evt) {
              // console.log("tileloaderror " + this.name);
            });
            this.events.register("tileloadend", this, function(evt) {
              // console.log("tileloadend " + this.name);
              this.scheduleMergeFeatures(this.tileloadDelay);
            });
            this.events.register("tileunload", this, function(evt) {
              // console.log("tileunload " + this.name);
            });
          },
          ...
          addTileFeatures : function(features) {
            ...
            evt.features.forEach(function(feature) {
              feature.fid = feature.attributes.id;
            });
            if (this.strategies) {
            ...
            this.bufferLayer.addFeatures(evt.features, null);
          },
          ...
          /**
           * Schedules the clearing of the features accumulated in the hidden
           * tile layer
           *
           * Parameters: delay {Number} delay time in ms
           */
          ...
          mergeFeatures : function() {
            ...
            console.log("features before merging " + this.bufferLayer.features.length);
            ...
            // Adds the features from the object jstsFeatures in the layer
            Object.getOwnPropertyNames(jstsFeatures).forEach(
                function(id) {
                  var newFeat = new OpenLayers.Feature.Vector(olParser
                      .write(jstsFeatures[id].geometry),
                      jstsFeatures[id].attributes);
                  newFeat.fid = id;
                  self.featureLayer.addFeatures(newFeat);
                });

            console.log("features after merging " + this.featureLayer.features.length);

            this.scheduleClearFeatures(this.tileloadDelay * 2); // TODO: make it
            // a parameter ?
          },
